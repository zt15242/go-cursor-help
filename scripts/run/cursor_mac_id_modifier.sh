...
show_follow_info() {
    echo
    echo -e "${GREEN}================================${NC}"
    echo -e "${YELLOW}  请添加QQ:2717718875 一起交流更多Cursor技巧和AI知识 ${NC}"
    echo -e "${GREEN}================================${NC}"
    echo
}
...
main() {
   ...
   ╚██████╗╚██████╔╝██║  ██║███████║╚██████╔╝██║  ██║
    ...
    echo -e "${YELLOW}  请添加QQ:2717718875     ${NC}"
    echo -e "${YELLOW}  一起交流更多Cursor技巧和AI知识  ${NC}"
    echo -e "${BLUE}================================${NC}"
    echo
    echo -e "${YELLOW}[重要提示]${NC} 本工具默认会修改系统 MAC 地址 (临时) 并修改 JS 文件以重置设备标识。"
    echo -e "${YELLOW}[重要提示]${NC} 本工具免费，如果对您有帮助，请添加QQ:2717718875"
    echo
