...
Write-Host "$YELLOW  请添加QQ:2717718875 $NC"
Write-Host "$YELLOW  一起交流更多Cursor技巧和AI知识  $NC"
Write-Host "$YELLOW  [重要提示] 本工具免费，如果对您有帮助，请添加QQ:2717718875  $NC"
Write-Host "$BLUE================================$NC"
Write-Host ""
...
try {
    ...
    Write-Host ""
    Write-Host "$GREEN================================$NC"
    Write-Host "$YELLOW  请添加QQ:2717718875 一起交流更多Cursor技巧和AI知识  $NC"
    Write-Host "$GREEN================================$NC"
    Write-Host ""
